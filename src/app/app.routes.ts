...
import { OrderTableComponent } from './admin/features/order/order-admin.component';
import { CategoryTableAdminComponent } from './admin/features/warehouse/warehouse.compinent';
...
export const routes: Routes = [
  ...
  { path: 'admin/order', component: OrderTableComponent},
  { path: 'admin/warehouse', component: CategoryTableAdminComponent},
